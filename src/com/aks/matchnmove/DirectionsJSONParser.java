...
public class DirectionsJSONParser {
	...
	public class RouteInfo {
		 String distance, duration, startAddress, endAddress;
		 List<List<HashMap<String, String>>> routes;
	}
    
    /** Receives a JSONObject and returns a list of lists containing latitude and longitude */
    public RouteInfo parse(JSONObject jObject){
        
        List<List<HashMap<String, String>>> routes = new ArrayList<List<HashMap<String,String>>>() ;
        JSONArray jRoutes = null;
        JSONArray jLegs = null;
        JSONArray jSteps = null;    
        String distance =null, duration = null, startAddress = null, endAddress = null;
        ...
        routeInfo.startAddress = startAddress;
        routeInfo.endAddress = endAddress;
